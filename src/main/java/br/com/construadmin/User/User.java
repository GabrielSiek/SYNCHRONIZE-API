...
public class User implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        if (this.role == Role.ADMIN)
            return List.of(new SimpleGrantedAuthority("ROLE_ADMIN"), new SimpleGrantedAuthority("ROLE_COMPLETO"), new SimpleGrantedAuthority("ROLE_ENCARREGADO"));
        else if (this.role == Role.COMPLETO)
            return List.of(new SimpleGrantedAuthority("ROLE_COMPLETO"), new SimpleGrantedAuthority("ROLE_ENCARREGADO"));
        else
